        ...
        <div className="modal-content" style={{paddingBottom:'10px'}}>
          ...
          <div className="row" style={{ margin:'0'}}>
            <div class="input-field col s12" style={{marginBottom:'0'}}>
              ...
              <label for="originalTitle" style={{ color:'#21ffe2' }}>{t('Original Title')}</label>
            </div>
            <div class="input-field col s12" style={{color:'#21ffe2'}}>
              <select style={{background:'#000417'}}>
                <option value="" disabled selected style={{color:'#fff'}}>{t('Choose your option')}</option>
                <option value="1">{t('Movie')}</option>
                <option value="2" style={{color:'#20f8'}}>{t('Program')}</option>
                <option value="3" style={{color:'#20f8'}}>Trailer</option>
              </select>
            </div>
            <textarea type="text-box" class="textBox" placeholder={t('More Details') + '..'} style={{marginTop:'10px'}}/>
            <div className="col s12 row" style={{margin:'0', marginBottom:'10px' }}>
              ...
              <div className="col s12 m6">
                <button className="modal-close btn" style={{ background: '#F34335', fontWeight:'600' }}><i class="material-icons right">send</i>{t('send')}</button>
              </div>
            </div>
          </div>
        </div>
